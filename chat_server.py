...
# ==============================================================================
                ...
                # ---- start your code ---- #
                text = msg["message"]
                self.indices[from_name].add_msg(text)
                ctime = time.strftime('%d.%m.%y,%H:%M', time.localtime())
                index = "({}){}".format(from_name, ctime)
                self.indices[from_name].indexing(text, index)                
...
# ==============================================================================
                ...
                try:
                    poem = "" 
                    for i in self.sonnet.get_poem(poem_num):
                        poem += i
                except:
                    print("ERROR")
                    poem = ""
...
# ==============================================================================
                ...
                search_rslt = str(self.indices[from_name].search(keyword))
